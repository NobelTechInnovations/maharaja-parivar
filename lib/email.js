...
export function sendWelcomeEmail(user) {
  return sendEmail({
    ...
    html: `${BRAND_HEADER}
      <p>Hi ${user.name},</p>
      <p>Thanks for joining <strong>Maharaja Parivar</strong>. Your registration is now waiting on our team's review — you'll get an email as soon as your profile is verified and visible to other Maharajians.</p>
      ${BRAND_FOOTER}`,
  });
}
