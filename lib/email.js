...
export function sendWelcomeEmail(user) {
  return sendEmail({
    ...
    text: `Hi ${user.name}, thanks for joining Maharaja Parivaar. Your registration is being reviewed by our team — you'll get an email once your profile is verified.`,
    html: `${BRAND_HEADER}
      <p>Hi ${user.name},</p>
      <p>Thanks for joining <strong>Maharaja Parivaar</strong>. Your registration is now waiting on our team's review — you'll get an email as soon as your profile is verified and visible to other Maharajians.</p>
      ${BRAND_FOOTER}`,
  });
}
